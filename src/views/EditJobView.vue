...
// import router from '@/router';  // Either you this router method
import { useRouter, useRoute } from 'vue-router';   // or this method
...
onMounted(async () => {
    try {
        ...
        // Populate the inputs
        form.type = reactiveState.job.type
        form.title = reactiveState.job.title
        form.description = reactiveState.job.description
        form.salary = reactiveState.job.salary
        form.location = reactiveState.job.location
        form.company.name = reactiveState.job.company.name
        form.company.description = reactiveState.job.company.description
        form.company.contactEmail = reactiveState.job.company.contactEmail
        form.company.contactPhone = reactiveState.job.company.contactPhone
    } catch (error) {
